...
export const InputSidebar = ({date, setDate, metric, setMetric, interval, setInterval}) => {
  return (
    <div className="component-cards">
      <div className="component-heading"> 
        {'COVID-19 Data Dashboard 🦠'} </div>
      ...
      <div className="component-body">
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'left', alignItems: 'start', gap: '8px', marginBottom: '10px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'left', alignItems: 'start', gap: '8px', marginBottom: '10px' }}>
          {Object.values(Interval).map((intervalItem) => {
              ...
              if (intervalItem === Interval.TOTAL) {
                if (metric === Metric.VENTILATOR || metric === Metric.ICU || metric === Metric.TOTAL_HOSPITALIZATIONS) {
                  label = intervalItem + ' (Currently)';
                } else {
